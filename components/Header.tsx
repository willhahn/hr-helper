      ...
      <div className="max-w-6xl mx-auto px-4 py-4 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <nav className="flex bg-slate-100 p-1 rounded-xl shadow-inner">
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${activeTab === TabType.LIST
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${activeTab === TabType.LUCKY_DRAW
              ? 'bg-white text-indigo-600 shadow-sm'
              : 'text-slate-500 hover:text-slate-700'
              }`}
          >
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${activeTab === TabType.GROUPING
              ? 'bg-white text-indigo-600 shadow-sm'
              : 'text-slate-500 hover:text-slate-700'
              }`}
          >
